...
const SCENARIOS = [
  { id: 'nature', label: 'Naturaleza', elements: ['vegetación densa', 'luz filtrada', 'suelo natural'], outdoor: true, acoustics: 'natural', donde: 'de pie sobre el suelo del claro, con vegetación en primer término y la espesura cerrándose detrás', movimiento: 'las hojas y la vegetación se mueven con el aire; la luz filtrada cambia despacio' },
  { id: 'forest', label: 'Bosque', elements: ['troncos altos', 'musgo', 'rayos de luz entre las copas', 'niebla baja'], outdoor: true, acoustics: 'natural', donde: 'de pie sobre la tierra y el musgo del bosque, CON TRONCOS DELANTE Y DETRÁS de él: los árboles rodean, no son un telón al fondo', movimiento: 'las ramas y las hojas se mecen sin parar, la niebla baja se desplaza y los rayos de luz entre las copas tiemblan' },
  { id: 'mountain', label: 'Montaña', elements: ['cumbres lejanas', 'roca desnuda', 'cielo abierto'], outdoor: true, acoustics: 'reverberant', donde: 'sobre la roca de un rellano, con la ladera cayendo por delante y las cumbres muy al fondo', movimiento: 'las nubes corren despacio y el viento mueve la hierba y el polvo de la roca' },
  { id: 'beach', label: 'Playa', elements: ['orilla', 'arena húmeda', 'horizonte marino'], outdoor: true, acoustics: 'dry', donde: 'con los pies en la arena húmeda de la orilla, dejando huella, y el mar rompiendo detrás', movimiento: 'las olas rompen y se retiran, la espuma avanza por la arena y el viento mueve el pelo y la ropa' },
  { id: 'desert', label: 'Desierto', elements: ['dunas', 'cielo despejado', 'calima'], outdoor: true, acoustics: 'dry', donde: 'sobre la arena de una duna, con los pies hundidos, y más dunas por delante y por detrás', movimiento: 'la arena vuela en la cresta de las dunas y la calima tiembla sobre el suelo' },
  { id: 'lake', label: 'Lago', elements: ['agua en calma', 'reflejos', 'juncos en la orilla'], outdoor: true, acoustics: 'natural', donde: 'en la orilla misma, con juncos en primer término y el agua abriéndose detrás', movimiento: 'el agua se riza, los reflejos oscilan y los juncos se inclinan con el aire' },
  { id: 'river', label: 'Río', elements: ['corriente', 'piedras húmedas', 'vegetación de ribera'], outdoor: true, acoustics: 'natural', donde: 'sobre las piedras húmedas de la ribera, con la corriente pasando por delante', movimiento: 'la corriente baja sin parar, el agua brilla y salpica entre las piedras' },
  { id: 'field', label: 'Campo', elements: ['hierba alta', 'horizonte bajo', 'cielo amplio'], outdoor: true, acoustics: 'dry', donde: 'metido entre la hierba alta, que le llega por las piernas y le tapa los pies', movimiento: 'la hierba alta ondea en oleadas con el viento' },
  { id: 'auditorium', label: 'Auditorio', elements: ['butacas en penumbra', 'escenario iluminado', 'techo acústico'], outdoor: false, acoustics: 'reverberant', donde: 'DE PIE SOBRE EL ESCENARIO ILUMINADO, nunca entre las butacas: las butacas quedan POR DELANTE y POR DEBAJO, vistas desde el escenario', movimiento: 'el polvo flota en los haces de luz y las luces de sala laten muy levemente' },
  { id: 'theatre', label: 'Teatro', elements: ['telón', 'palcos', 'foco cenital'], outdoor: false, acoustics: 'reverberant', donde: 'sobre las tablas del escenario, bajo el foco cenital, con el telón detrás y el patio de butacas por delante y más abajo', movimiento: 'el telón se mueve apenas y el polvo flota dentro del haz del foco' },
  { id: 'stadium', label: 'Estadio', elements: ['gradas', 'estructura de luces', 'escenario grande'], outdoor: true, acoustics: 'cavernous', donde: 'sobre el escenario montado en el centro del campo, con las gradas rodeándolo a lo lejos y muy por encima', movimiento: 'las luces de las torres parpadean y el público se mueve como una masa lejana' },
  { id: 'open_air_concert', label: 'Concierto al aire libre', elements: ['escenario montado', 'torres de luz', 'público lejano'], outdoor: true, acoustics: 'natural', donde: 'sobre las tablas del escenario montado, con las torres de luz a los lados y el público abajo, delante de él', movimiento: 'los focos barren el escenario, el humo se desplaza y el público se mueve abajo' },
  { id: 'square', label: 'Plaza', elements: ['pavimento de piedra', 'fachadas alrededor', 'farolas'], outdoor: true, acoustics: 'reverberant', donde: 'de pie sobre el pavimento de piedra, con las fachadas cerrando la plaza alrededor', movimiento: 'las farolas parpadean y alguna hoja o papel cruza el suelo con el aire' },
  { id: 'street', label: 'Vía pública', elements: ['acera', 'escaparates', 'tráfico al fondo'], outdoor: true, acoustics: 'dry', donde: 'sobre la acera, con el bordillo y la calzada por delante y los escaparates a su espalda', movimiento: 'coches y luces pasan al fondo y algún transeúnte cruza' },
  { id: 'city', label: 'Ciudad', elements: ['siluetas de edificios', 'luces urbanas', 'reflejos en cristal'], outdoor: true, acoustics: 'reverberant', donde: 'sobre el asfalto mojado, con los edificios elevándose a los lados y cerrándose sobre él', movimiento: 'las luces de la ciudad titilan y los reflejos se desplazan sobre el cristal y el asfalto' },
  { id: 'rooftop', label: 'Azotea', elements: ['skyline al fondo', 'suelo de grava', 'antenas'], outdoor: true, acoustics: 'dry', donde: 'sobre la grava de la azotea, con el pretil por delante y el skyline mucho más atrás y más abajo', movimiento: 'el viento mueve el pelo y la ropa, y las luces del skyline titilan a lo lejos' },
  { id: 'church', label: 'Iglesia', elements: ['columnas', 'vidrieras', 'bancos de madera'], outdoor: false, acoustics: 'cavernous', donde: 'en el pasillo central, entre los bancos de madera, con las columnas a los lados y el altar al fondo', movimiento: 'el polvo flota en la luz de las vidrieras y la llama de las velas tiembla' },
  { id: 'temple', label: 'Templo', elements: ['madera lacada', 'lámparas colgantes', 'suelo de piedra'], outdoor: false, acoustics: 'reverberant', donde: 'sobre el suelo de piedra, bajo las lámparas colgantes, con la madera lacada alrededor', movimiento: 'las lámparas colgantes oscilan apenas y el humo del incienso sube' },
  { id: 'room', label: 'Habitación', elements: ['ventana lateral', 'pared sencilla', 'suelo de madera'], outdoor: false, acoustics: 'dry', donde: 'sobre el suelo de madera, cerca de la ventana lateral, con la pared a su espalda', movimiento: 'la cortina se mueve con el aire de la ventana y el polvo flota en la luz' },
  { id: 'studio', label: 'Estudio', elements: ['paneles acústicos', 'focos dirigidos', 'fondo neutro'], outdoor: false, acoustics: 'dry', donde: 'sobre el suelo del estudio, entre los paneles acústicos, con los focos dirigidos hacia él', movimiento: 'las luces laten muy levemente y el polvo flota en los haces dirigidos' },
  { id: 'other', label: 'Otro', elements: [], outdoor: false, acoustics: 'natural', donde: '', movimiento: '' },
];
