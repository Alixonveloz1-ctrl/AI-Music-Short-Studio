 ...
 * en una frase inglesa, igual que se hace con el carácter.
 *
...
// AQUÍ VIVÍA EL ENCARGO DEL SONIDO AMBIENTAL, con sus dos caminos: las capas
// para el sintetizador y un prompt en inglés para la IA, más las tablas que
// traducían los cuarenta y siete ambientes del catálogo.
//
// Se ha borrado entero con el resto del ambiente. El sintetizado sonaba a ruido
// plano por mucho que la lista dijera «viento, hojas, pájaros», y el de IA
// fallaba casi siempre y cuando salía traía música dentro. Un corto instrumental
// no necesita una segunda pista peleándose con la única que importa.

module.exports = { construirPlan, briefMusical };
